...
from Books_recommendor.utils.utility import read_yaml_file
from Books_recommendor.exception.exception_handler import AppException
from Books_recommendor.entity.config_entity import DataIngestionConfig,DataValidationConfig,DataTransformationConfig,ModelTrainerConfig,ModelRecommendationConfig
from Books_recommendor.constants import *
...
class AppConfiguration:
    ...
    def get_data_validation_config(self) -> DataValidationConfig:
        try:
            ...
            books_csv_file_dir = os.path.join(
                artifacts_dir,
                dataset_dir,
                data_ingestion_config['ingested_dir'],
                books_csv_file
            ...
            ratings_csv_file_dir = os.path.join(
                artifacts_dir,
                dataset_dir,
                data_ingestion_config['ingested_dir'],
                ratings_csv_file
    ...
    def get_recommendation_config(self) -> ModelRecommendationConfig:
        try:
            ...
            book_name_serialized_objects = os.path.join(
                artifacts_dir,
                data_validation_config["serialized_objects_dir"],
                "book_names.pkl"
            )
